...
//
//  Created by Sergey Kovalev on 3/22/22.
//
...
let handbooks = [
    ...
    Course(title: "Figma Design Handbook", subtitle: "40 sections - 5 hours", description: "A comprehensive series of tutorials on Figma deisgns and more!", icon: UIImage(named: "Logo React")!, banner: UIImage(named: "Illustration 3")!, authors: ["Sergey Kovalev, Natalia Kovaleva"], colors: [
        UIColor(red: 0.71, green: 0.155, blue: 0.337, alpha: 1).cgColor,
        UIColor(red: 0.183, green: 0.883, blue: 0.223, alpha: 1).cgColor,
        UIColor(red: 0.584, green: 0.947, blue: 0.345, alpha: 1).cgColor
    ], sections: sections)*/
]
